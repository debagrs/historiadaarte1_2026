...
import { ArrowLeft, ArrowRight, ExternalLink, Presentation, Sparkles } from "lucide-react";
    ...
    <section id="apresentacoes-pesquisa" className="border-t border-[#E8E2D8] bg-[#F7F2EA] px-4 py-10 sm:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <a href="https://prezi.com/czjj7i8at52v/pre-historia-da-arte/" target="_blank" rel="noreferrer" className="rounded-xl border border-[#E8E2D8] bg-white p-5 transition hover:border-[#A83B24]">
            <Presentation className="h-6 w-6 text-[#A83B24]" /><h3 className="mt-3 font-serif text-2xl font-semibold">Apresentação histórica</h3><p className="mt-2 text-[#5E584F]">Acesse a apresentação anterior da disciplina como documento da trajetória pedagógica da aula.</p>
          </a>
        </div>
      </div>
    </section>
